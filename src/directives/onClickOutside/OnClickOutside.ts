...
} from '@/directives/onClickOutside/OnClickOutside.types';
import type { DirectiveBinding } from 'vue';

export default {
  name: 'onClickOutside',
  mounted(el: IOnClickOutsideElement, binding: DirectiveBinding<TOnClickOutsideDirectiveBinding>) {
    if (!binding.value) {
      throw new Error('[OnClickOutside]: directive does not have a handler binding.');
    }
